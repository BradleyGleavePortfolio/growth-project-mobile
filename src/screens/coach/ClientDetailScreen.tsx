        ...
        {activeTab === 'summary' && (
          <>
            ...
            <CoachAiSection
              clientId={clientId}
              clientName={route.params.clientName}
              clientAllergies={extractClientAllergies(profile as unknown as LooseProfileRecord | null)}
              clientDietaryRestrictions={extractClientDietaryRestrictions(profile as unknown as LooseProfileRecord | null)}
            />
          </>
        )}

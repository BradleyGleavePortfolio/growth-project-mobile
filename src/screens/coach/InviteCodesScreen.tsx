...
const styles = StyleSheet.create({
  ...
  modalContent: { width: '85%', backgroundColor: Colors.surface, borderRadius: 16, padding: 24 },
  ...
  modalCancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: Colors.surfaceElevated, alignItems: 'center' },
  modalCancelText: { fontSize: 15, fontWeight: '600', color: Colors.textSecondary },
  modalSaveBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, backgroundColor: Colors.primary, alignItems: 'center' },

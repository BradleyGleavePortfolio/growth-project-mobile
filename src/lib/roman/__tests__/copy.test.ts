...
// ──────────────────────────────────────────────────────────────────────────
// Roman P4 showpiece copy — §2.6 First Payment Wow (ED.3) + ED.4 PR commentary.
// Added ADDITIVELY (P3/P4 split). The P3 forbidden-move sweep above iterates
// ONLY P3 strings, so it never asserts against romanFirstPayment; the P4 voice
// contract below owns the exclamation accounting for §2.6 — the §2.6
// celebration variant carries the session's single rationed exclamation
// (spec §1.4 + §4), while every other P4 string stays exclamation-free.
// ──────────────────────────────────────────────────────────────────────────
